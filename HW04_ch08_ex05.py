...
# For example, “cheer” rotated by 7 is “jolly” and “melon” rotated by -10 is “cubed”. In the movie 2001: A Space Odyssey, the ship computer is called HAL, which is IBM rotated by -1.

# Write a function called rotate_word that 
...
# and chr, which converts numeric codes to characters. Letters of the alphabet are encoded in alphabetical order, so for example:
...
def rotate_word(word, amount):
	# Rotate a word by how many amount of places in alphebetical order. 
	rotated = ' '
	for letter in word:
